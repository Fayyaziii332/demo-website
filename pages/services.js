      ...
      <header className="flex items-center justify-between flex-wrap  px-12 py-6 mx-auto w-full z-10 top-0 border-b-2 border-gray-100">
        <div className="flex items-center flex-shrink-0 text-white mr-6">
          <a className="text-white no-underline hover:text-white hover:no-underline" href="#" aria-label="logo">
            <img className="h-8 w-auto sm:h-10" src="logo.svg" alt="logo" width="" height="" />
        ...
        <section className="text-gray-600 body-font">
          <div className="container px-5 py-12 mx-auto">
            <div className="text-center mb-20">
              <h1 className="sm:text-3xl text-2xl font-medium text-center title-font text-gray-900 mb-4">Our Services</h1>
              <p className="text-base leading-relaxed lg:w-2/3 mx-auto">We assist you with pre and post-migration
            ...
            <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
              <div className="p-2 sm:w-1/2 w-full">
                <div className="bg-gray-100 rounded flex p-4 h-full items-center">
                  ...
                  <span className="title-font font-medium">Solutions For AWS</span>
                </div>
              </div>
              <div className="p-2 sm:w-1/2 w-full">
                <div className="bg-gray-100 rounded flex p-4 h-full items-center">
                  ...
                  <span className="title-font font-medium">Solutions For IBM</span>
                </div>
              </div>
              <div className="p-2 sm:w-1/2 w-full">
                <div className="bg-gray-100 rounded flex p-4 h-full items-center">
                  ...
                  <span className="title-font font-medium">Migration as Service</span>
                </div>
              </div>
              <div className="p-2 sm:w-1/2 w-full">
                <div className="bg-gray-100 rounded flex p-4 h-full items-center">
                  ...
                  <span className="title-font font-medium">Diaster Recovery as Service</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="text-gray-600 body-font">
          <div className="container px-5 py-12 mx-auto">
            <div className="flex flex-col text-center w-full mb-12">
              <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Subscribe for more</h1>
              <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Wanclouds offer products and services to automate
