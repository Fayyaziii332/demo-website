      ...
      <header class="flex items-center justify-between flex-wrap  px-12 py-6 mx-auto w-full z-10 top-0 border-b-2 border-gray-100">
        <div class="flex items-center flex-shrink-0 text-white mr-6">
          <a class="text-white no-underline hover:text-white hover:no-underline" href="#" aria-label="logo">
            <img class="h-8 w-auto sm:h-10" src="logo.svg" alt="logo" width="" height="" />
        ...
        <section class="text-gray-600 body-font">
          <div class="container px-5 py-12 mx-auto">
            <div class="text-center mb-20">
              ...
              <p class="text-base leading-relaxed lg:w-2/3 mx-auto">We assist you with pre and post-migration
            ...
            <div class="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
              <div class="p-2 sm:w-1/2 w-full">
                <div class="bg-gray-100 rounded flex p-4 h-full items-center">
                  ...
                  <span class="title-font font-medium">Solutions For AWS</span>
                </div>
              </div>
              <div class="p-2 sm:w-1/2 w-full">
                <div class="bg-gray-100 rounded flex p-4 h-full items-center">
                  ...
                  <span class="title-font font-medium">Solutions For IBM</span>
                </div>
              </div>
              <div class="p-2 sm:w-1/2 w-full">
                <div class="bg-gray-100 rounded flex p-4 h-full items-center">
                  ...
                  <span class="title-font font-medium">Migration as Service</span>
                </div>
              </div>
              <div class="p-2 sm:w-1/2 w-full">
                <div class="bg-gray-100 rounded flex p-4 h-full items-center">
                  ...
                  <span class="title-font font-medium">Diaster Recovery as Service</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section class="text-gray-600 body-font">
          <div class="container px-5 py-12 mx-auto">
            <div class="flex flex-col text-center w-full mb-12">
              <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Subscribe for more</h1>
              <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Wanclouds offer products and services to automate
                    and solve challenges related to Cloud Migrations & Disaster Recovery.</p>
            </div>
            <form class="flex lg:w-2/3 w-full sm:flex-row flex-col mx-auto px-8 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 items-end">
              ...
              <button class="text-white bg-indigo-600 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-900 rounded text-lg">
                Submit
                </button>
            </form>
          </div>
