...
export default function Home() {
  return (
    <>
      ...
      <header class="flex items-center justify-between flex-wrap px-12 py-6 mx-auto w-full z-10 top-0 border-b-2 border-gray-100">
        <div class="flex items-center flex-shrink-0 text-white mr-6">
          <a class="text-white no-underline hover:text-white hover:no-underline" href="#" aria-label="logo">
        ...
        <nav class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block pt-6 lg:pt-0" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            <li class="mr-3">
              <Link href="/">
                <a class="inline-block text-gray-500 hover:text-gray-900 no-underline px-4 py-2" >Home</a>
              </Link>
            </li>
            <li class="mr-3">
              <Link href="/services" >
                <a class="inline-block text-gray-500 hover:text-gray-900 no-underline px-4 py-2">Services</a>
              </Link>
            </li>
            <li>
              <Link href="/contact" >
              <a class="inline-block text-gray-500 hover:text-gray-900 no-underline px-4 py-2">ContactUs</a>
              </Link>
            </li>
            <li>
              <a href="/"
                class="ml-4 whitespace-nowrap flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-900">
                Sign up </a>
            </li>
          </ul>
        </nav>
      ...
      <main>
        <section class="text-gray-600 body-font">
          <div class="container mx-auto flex px-5 pt-24 pb-12 sm:flex-row flex-col items-center">
            <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
              <h1 class="title-font sm:text-4xl text-4xl mb-4 font-medium text-indigo-600">
                Multi-Cloud Migrations and
                        <br class="hidden lg:inline-block" /> Disaster Recovery
                    </h1>
              <p class="mb-8 leading-relaxed">Re-Imagine Multi-Cloud Migrations, Disaster Recovery , Visualization
                        <br class="hidden lg:inline-block" /> and Compliance delivered as a Service .</p>
              <div class="flex justify-center">
                <button class="flex-row flex-wrap sm:flex-col text-white bg-indigo-600 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-900 rounded text-lg">
                  Demo
                        </button>
        ...
        <section class="text-gray-600 body-font">
          <div class="container px-5 py-12 mx-auto">
            <div class="flex flex-col text-center w-full mb-12">
              <h1 class="text-3xl font-medium title-font mb-4 text-indigo-600">OUR TEAM</h1>
              <p class="lg:w-2/3 mx-auto leading-relaxed text-base">We are a team of cloud enthusiasts headquartered
              ...
              <div class="p-4 lg:w-1/4 md:w-1/2">
                <div class="h-full flex flex-col items-center text-center">
                  ...
                  <div class="w-full">
                    ...
                    <p class="mb-4">Faiz was an executive at Cisco & played multiple leadership roles.</p>
                    <span class="inline-flex">
                      <a class="text-gray-700" href="https://www.facebbok.com/" target="_blank" aria-label="Facebook">
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          class="w-6 h-6" viewBox="0 0 24 24">
                          <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                        </svg>
                      </a>
                      <a class="ml-2 text-gray-700" href="https://www.twitter.com/" target="_blank" aria-label="Twitter">
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          class="w-6 h-6" viewBox="0 0 24 24">
                          <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
                        </svg>
                      </a>
                      <a class="ml-2 text-gray-500" href="https://www.linkedin.com/" target="_blank" aria-label="Linkedin">
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          class="w-6 h-6" viewBox="0 0 24 24">
              ...
              <div class="p-4 lg:w-1/4 md:w-1/2">
                <div class="h-full flex flex-col items-center text-center">
                  ...
                  <div class="w-full">
                    ...
                    <p class="mb-4">Zayad is Marketing head and Business Development.
                                    .</p>
                    <span class="inline-flex">
                      <a class="text-gray-700" href="https://www.facebbok.com/" target="_blank" aria-label="Facebook">
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              ...
              <div class="p-4 lg:w-1/4 md:w-1/2">
                <div class="h-full flex flex-col items-center text-center">
                  ...
                  <div class="w-full">
                    ...
                    <p class="mb-4">Syed Faizullah is Director Network Solutions Engineering
                                    .</p>
                    <span class="inline-flex">
                      <a class="text-gray-700" href="https://www.facebbok.com/" target="_blank" aria-label="Facebook">
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              ...
              <div class="p-4 lg:w-1/4 md:w-1/2">
                <div class="h-full flex flex-col items-center text-center">
                  ...
                  <div class="w-full">
                    ...
                    <p class="mb-4">Maimoona Iqbal is Company's Engineering Lead
                                    .</p>
                    <span class="inline-flex">
                      <a class="text-gray-700" href="https://www.facebbok.com/" target="_blank" aria-label="Facebook">
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <section class="text-gray-600 body-font">
          <div class="container px-5 py-12 mx-auto">
            <div class="flex flex-col text-center w-full mb-12">
              <h1 class="text-3xl font-medium title-font mb-4 text-indigo-600">OUR SERVICES</h1>
              <p class="lg:w-2/3 mx-auto leading-relaxed text-base">We assist you with pre and post-migration
            ...
            <div class="flex flex-wrap -m-4 text-center">
              <div class="p-4 sm:w-1/4 w-1/2 ">
                <p class="leading-relaxed bg-gray-200 py-8 text-lg">Solutions For AWS</p>
              </div>
              <div class="p-4 sm:w-1/4 w-1/2 ">
                <p class="leading-relaxed bg-gray-200 py-8 text-lg">Solutions For IBM</p>
              </div>
              <div class="p-4 sm:w-1/4 w-1/2 ">
                <p class="leading-relaxed bg-gray-200 py-8 text-lg">Migration </p>
              </div>
              <div class="p-4 sm:w-1/4 w-1/2 ">
                <p class="leading-relaxed bg-gray-200 py-8 text-lg">Recovery </p>
              </div>
            </div>
          </div>
        </section>
        ...
        <div class="container px-5 py-12 mx-auto">
          <div class="flex flex-col text-center w-full ">
            <h1 class="text-3xl font-medium title-font mb-4 text-indigo-600">TESTIMONIAL</h1>
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base mb-4">
          ...
          <article class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center mt-4">
            ...
            <p class="leading-relaxed text-lg">Wanclouds Inc have years of experience with Migrations, DevOps and
      ...
      <footer class="text-gray-600 body-font border-t-2 border-gray-100 ">
        <nav class="container px-5 py-12 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
            <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900" href="#">
              ...
              <span class="ml-3 text-xl">Wanclouds Inc</span>
            </a>
            <p class="mt-4 text-gray-500">2811 Mission College Blvd, 7th Floor, Santa Clara, CA 95054, USA</p>
          </div>
          <div class="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 class="title-font font-medium text-gray-900 tracking-widest mb-6 text-xl ">SERVICES</h2>
              <ul class="list-none mb-10">
                <li class="mb-2">
                  <a class="text-gray-500 hover:text-gray-800" href="#">Solutions For AWS</a>
                </li>
                <li class="mb-2">
                  <a class="text-gray-500 hover:text-gray-800" href="#">Solutions For IBM</a>
                </li>
                <li class="mb-2">
                  <a class="text-gray-500 hover:text-gray-800" href="#">Migration </a>
                </li>
                <li class="mb-2">
                  <a class="text-gray-500 hover:text-gray-800" href="#">Recovery </a>
                </li>
              </ul>
            </div>
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 class="title-font font-medium text-gray-900 tracking-widest mb-6 text-xl ">PRODUCTS</h2>
              <ul class="list-none mb-10">
                <li class="mb-2">
                  <a class="text-gray-500 hover:text-gray-800" href="#">Vpc+</a>
                </li>
                <li class="mb-2">
                  <a class="text-gray-500 hover:text-gray-800" href="#">Ongoing Services</a>
                </li>
                <li class="mb-2">
                  <a class="text-gray-500 hover:text-gray-800" href="#">Offerings</a>
                </li>
              </ul>
            </div>
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 class="title-font font-medium text-gray-900 tracking-widest mb-6 text-xl ">RESOURCES</h2>
              <ul class="list-none mb-10">
                <li class="mb-2">
                  <a class="text-gray-500 hover:text-gray-800" href="#">Blogs</a>
                </li>
                <li class="mb-2">
                  <a class="text-gray-500 hover:text-gray-800" href="#">Configurations</a>
                </li>
                <li class="mb-2">
                  <a class="text-gray-500 hover:text-gray-800" href="#">Support</a>
                </li>
                <li class="mb-2">
            ...
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 class="title-font font-medium text-gray-900 tracking-widest mb-6 text-xl ">ABOUT US</h2>
              <ul class="list-none mb-10">
                <li class="mb-2">
                  <a class="text-gray-500 hover:text-gray-800" href="#">company</a>
                </li>
                <li class="mb-2">
                  <a class="text-gray-500 hover:text-gray-800" href="#">Products</a>
                </li>
                <li class="mb-2">
                  <a class="text-gray-500 hover:text-gray-800" href="#">Services</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="bg-gray-200">
          <nav class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row ">
            <p class="text-gray-700 text-sm text-center sm:text-left mt-1 ">© 2022 —
                <a href="#" rel="noopener noreferrer" class="text-gray-700 ml-1" target="_blank">Wanclouds Inc</a>
            </p>
            <span class="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
              <a class="text-gray-700" href="https://www.facebook.com/" target="_blank" aria-label="facebook">
                <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-6 h-6"
                  viewBox="0 0 24 24">
                  <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                </svg>
              </a>
              <a class="ml-3 text-gray-700" href="https://www.twitter.com/" target="_blank" aria-label="Twitter">
                <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-6 h-6"
                  viewBox="0 0 24 24">
                  <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
                </svg>
              </a>
              <a class="ml-3 text-gray-700" href="https://www.instagram.com/" target="_blank" aria-label="instagram">
                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  class="w-6 h-6" viewBox="0 0 24 24">
              ...
              <a class="ml-3 text-gray-700" href="https://www.linkedin.com/" target="_blank" aria-label="linkedin">
