        ...
        <section class="text-gray-600 body-font relative">
          <div class="container px-5 py-12 mx-auto">
            <div class="flex flex-col text-center w-full mb-12">
              ...
              <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Wanclouds offer products and services to automate and solve challenges related to Cloud Migrations & Disaster Recovery.</p>
            </div>
            <div class="lg:w-1/2 md:w-2/3 mx-auto">
              <form class="flex flex-wrap m-2">
                ...
                <div class="p-2 w-full">
                  <button class="flex mx-auto text-white bg-indigo-600 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-900 rounded text-lg">Submit</button>
                </div>
                <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                  <a href="#">wancloudsInc@gmail.com</a>
                  <p class="leading-normal my-5">Headquartered in Santa Clara, CA.
                        <br />2811 Mission College Blvd, 7th Floor, Santa Clara, CA 95054, USA
                    </p>
                </div>
              </form>
            </div>
