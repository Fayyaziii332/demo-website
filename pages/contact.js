        ...
        <section className="text-gray-600 body-font relative">
          <div className="container px-5 py-12 mx-auto">
            <div className="flex flex-col text-center w-full mb-12">
              ...
              <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Wanclouds offer products and services to automate and solve challenges related to Cloud Migrations & Disaster Recovery.</p>
            </div>
            <div className="lg:w-1/2 md:w-2/3 mx-auto">
              <form className="flex flex-wrap m-2">
                ...
                <div className="p-2 w-full">
                  <button className="flex mx-auto text-white bg-indigo-600 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-900 rounded text-lg">Submit</button>
                </div>
                <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                  <a href="#">wancloudsInc@gmail.com</a>
                  <p className="leading-normal my-5">Headquartered in Santa Clara, CA.
        ...
        <div className="bg-gray-200">
          <nav className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row ">
            <p className="text-gray-700 text-sm text-center sm:text-left mt-1 ">© 2022 —
                <a href="#" rel="noopener noreferrer" className="text-gray-700 ml-1" target="_blank">Wanclouds Inc</a>
            </p>
            <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
              <a className="text-gray-700" href="https://www.facebook.com/" target="_blank" aria-label="facebook">
                <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-6 h-6"
                  viewBox="0 0 24 24">
                  <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                </svg>
              </a>
              <a className="ml-3 text-gray-700" href="https://www.twitter.com/" target="_blank" aria-label="Twitter">
                <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-6 h-6"
                  viewBox="0 0 24 24">
                  <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
                </svg>
              </a>
              <a className="ml-3 text-gray-700" href="https://www.instagram.com/" target="_blank" aria-label="instagram">
              ...
              <a className="ml-3 text-gray-700" href="https://www.linkedin.com/" target="_blank" aria-label="linkedin">
